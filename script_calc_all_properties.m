...
for i = 1 : length(series)
    ...
    for j = 1 : length(columns)
        ...
        column = columns{j};
        try 
            [properties, ~] = apply_inc_svdd(data, column, 50, 1, 0.1, 'r', 13);
            filename = ['data/collections/running-outside-almende/' serie '/properties_' metrics{j} '_b_50_t_1_s_13.mat'];
